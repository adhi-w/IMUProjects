...
//    ypr[2] = 360-convert.angleCorrection(ypr[2], q_offset[2]);
    ...
    theta[0] = convert.angleCorrection(theta[0], t_offset[0]);  
    theta[1] = convert.angleCorrection(theta[1], t_offset[1]);
    theta[2] = convert.angleCorrection(theta[2], t_offset[2]);
